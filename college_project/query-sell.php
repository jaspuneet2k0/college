...
<li style="display:block;padding:5px 0;border-bottom:1px solid #eee"><strong>Name:</strong> '.$name.'</li>
...
<li style="display:block;padding:5px 0;border-bottom:1px solid #eee"><strong>Machine Type:</strong> '.$type.'</li>
<li style="display:block;padding:5px 0;border-bottom:1px solid #eee"><strong>Model:</strong> '.$model.'</li>
<li style="display:block;padding:5px 0;border-bottom:1px solid #eee"><strong>Address:</strong> '.$address.'</li>
