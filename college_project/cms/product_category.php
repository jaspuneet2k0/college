    ...
    <div class="container-fluid">
      <div class="row">
		...
		<?php } ?>
          ...
          <h2 class="sub-header">All Categories</h2><div class="newpage"><a href="product_categoryadd.php">Add New Product Category</a></div>
            ...
            <table class="table table-striped" id="rounded-corner">
			  ...
			  ?>
                <tr>
                  ...
                  <td><a href="product_categoryEdit.php?id=<?php echo $row['id']; ?>">Edit</a></td>
                  <td><a href="delete.php?row=<?php echo $row['id']; ?>&tbl=product_category" class="ask"><img src="images/trash.png"></a></td>
                </tr>
