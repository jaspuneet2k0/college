...
//					echo '</table>';
					...
					// Insert info into database table!
					 ...
					 $sql = "insert into product (title, keywords, meta_desc,  product, category, content, code, ThumbName, show_on_home, path) Values ('$title' , '$keywords' , '$meta_desc', '$product', '$category', '$content', '$code', '$thumb_DestRandImageName', '$show_on_home','$DestRandImageName')";
					mysql_query($sql);
