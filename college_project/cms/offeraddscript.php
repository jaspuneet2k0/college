...
$DestinationDirectory	= '../images/offers/'; //Upload Directory ends with / (slash)
$Quality 				= 100;
...
//					echo '</table>';
					...
					// Insert info into database table!
					 ...
					 $sql = "insert into offer (model,  product, content, code, ThumbName, show_on_home, path) Values ('$model' , '$product', '$content', '$code', '$thumb_DestRandImageName', '$show_on_home','$DestRandImageName')";
					mysql_query($sql);
					
					header('location:offer.php?id=1');
